# Generated by Django 2.2.7 on 2020-01-07 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupation', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.Occupation')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.AddField(
            model_name='film',
            name='ratings',
            field=models.ManyToManyField(through='main.Rating', to='main.UserInformation'),
        ),
    ]
